...
@pytest.mark.parametrize("list_1, len_1, list_2, len_2, expected", [
    ([1, 2, 3, 0, 0, 0], 3, [2, 5, 6], 3, [1, 2, 2, 3, 5, 6]),
    ([1], 1, [], 0, [1]),
])
def test_merge(list_1, len_1, list_2, len_2, expected):
    Solution().merge(nums1=list_1, m=len_1, nums2=list_2, n=len_2)
    assert list_1 == expected
...
def test_merge_2(list_1, len_1, list_2, len_2, expected):
    Solution().merge_2(nums1=list_1, m=len_1, nums2=list_2, n=len_2)
    assert list_1 == expected
...
def test_merge_3(list_1, len_1, list_2, len_2, expected):
    Solution().merge_3(nums1=list_1, m=len_1, nums2=list_2, n=len_2)
    assert list_1 == expected
